...
client.on('message', message => {
	if (message.content === 'Gute Nacht')
		message.channel.send('Schlaf gut :heart:')
	
	else if (message.content === 'gute nacht')
		message.channel.send('Schlaf gut :heart:')
	...
	else if (message.content === 'Nacht')
		message.channel.send('Schlaf gut :heart:')
	
	else if (message.content === 'nacht')
		message.channel.send('Schlaf gut :heart:')
	
	else if (message.content === 'Nighty')
		message.channel.send('Schlaf gut :heart:')
